...
dep_date=st.date_input("",key='departure_date')
...
def dep_min_side():
	st.sidebar.subheader("4. You selected the Departure Minute")
...
def dur_hour_side():
	st.sidebar.subheader("4. You selected the Duration Hour")
...
def dur_min_side():
	st.sidebar.subheader("4. You selected the Duration Minute")
